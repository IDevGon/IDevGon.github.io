...
- #### 검색 페이지 Vue.js -> Next.js 마이그레이션 및 SSR, SEO
  2023. 10 ~ 2023. 12
  펫프렌즈의 검색 페이지를 Vue.js 기반에서 next.js 로 마이그레이션 하면서  
  서버사이드 렌더링(SSR)을 도입하여 초기 렌더링 속도 향상 및 SEO 를 향상 시켰습니다.  
  유저 정보를 서버에서 렌더링 하기 위해, 쿠키를 세팅하는 작업 및  
